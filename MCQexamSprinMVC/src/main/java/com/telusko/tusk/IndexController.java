...
public class IndexController
{
 ...
 public String home()
 {
	...
	//public String addFeedback(@RequestParam("name") String name,@RequestParam("email") String email,@RequestParam("reg") String reg,
		//	@RequestParam("code") String code,@RequestParam("rating") int rating)
